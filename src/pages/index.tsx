...
<span className="absolute left-0 block w-full h-0 transition-all bg-white/20 opacity-100 group-hover:h-full top-1/2 group:hover:text-neutral-900 hover:text-neutral-900 group-hover:top-0 duration-400 ease"></span>
